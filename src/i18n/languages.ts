...
export const uiTranslations = {
  en: {
    ...
    potatostudios: "Digital art studio.",
    tasle: "Responsive and lighter Tesla page clone with automatic language detection and region selection.",
    lavelada3remake:
  ...
  es: {
    ...
    phrase3:
      "Desde páginas de aterrizaje muy ligeras y rápidas hasta aplicaciones móviles nativas complejas, seguras y reactivas.",
    and: "y",
    metaDescription:
    ...
    potatostudios: "Estudio de arte digital.",
    tasle:
  ...
  ko: {
    ...
    potatostudios: "디지털 아트 스튜디오.",
    tasle: "자동 언어 감지 및 지역 선택이 포함된 반응형 및 가벼운 테슬라 페이지 복제본.",
    lavelada3remake:
  ...
  ru: {
    ...
    potatostudios: "Студия цифрового искусства.",
    tasle:
  ...
  de: {
    ...
    potatostudios: "Digitales Kunststudio.",
    tasle:
  ...
  it: {
    ...
    potatostudios: "Studio di arte digitale.",
    tasle:
  ...
  fr: {
    ...
    potatostudios: "Studio d'art numérique.",
    tasle:
