...
export const uiTranslations = {
  ...
  es: {
    ...
    "My blog": "Mi blog",
    blogDescription:
      "Blog personal donde retrato mis pensamientos sobre el cambiante mundo del desarrollo de software y tecnología en general. Logrado con 'Astro collections' para crear posts de una manera fácil y rápida.",
    blogPageText:
  ...
  ca: {
    ...
    "My blog": "El meu blog",
    blogDescription:
      "Blog personal on retrato els meus pensaments sobre el canviant món del software i tecnologia en general. Aconseguit amb 'Astro collections' per crear posts d'una manera fàcil i ràpida.",
    blogPageText:
  ...
  ru: {
    ...
    November: "Ноябрь",
    December: "Декабрь",
    "min read": "минуты чтения",
    "go back": "назад",
    Linkedin: "Линкедин",
    Twitter: "Твиттер",
    Github: "Гитхаб",
    Language: "Язык",
    "If you like my work and want to bring": "Если вам нравится моя работа и вы хотите привести",
    "your ideas": "ваши идеи",
    "to life online, let's collaborate!": "к жизни онлайн, давайте сотрудничать!",
    "Contact me to let me know and discuss your app or website needs.":
      "Свяжитесь со мной, чтобы сообщить мне и обсудить ваши потребности в приложении или веб-сайте.",
    Home: "Главная",
    Projects: "Проекты",
    Contact: "Контакты",
    phrase1: "Обязуюсь предоставлять решения высшего класса, придерживаясь лучших практик отрасли.",
    phrase2:
    ...
    "My blog": "Мой блог",
    blogDescription:
      "Личный блог, где я изображаю свои мысли о постоянно меняющемся мире технологий. Достигнуто с помощью Astro collections для создания постов легко и быстро.",
    blogPageText:
      "Ознакомьтесь с моими постами в блоге, где я изображаю свои мысли о постоянно меняющемся мире технологий для тех, кто заинтересован ☺",
    metaDescription:
