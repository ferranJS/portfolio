export default {
  driverjs: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://driverjs.com/">
...
`,
  tailwind: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://tailwindcss.com/">
    <i class="devicon-tailwindcss-plain text-2xl sm:text-3xl"></i>
  </a>
`,
  javascript: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://developer.mozilla.org/es/docs/Web/API/Canvas_API">
    <i class="devicon-javascript-plain text-[1.4rem] sm:text-[1.7rem]"></i>
  </a>
`,
  angular: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://angular.io/">
    <i class="devicon-angularjs-plain text-2xl sm:text-3xl"></i>
  </a>
`,
  astro: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://astro.build/">
    <svg class="w-6 sm:w-7" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="logosandtypes_com" data-name="logosandtypes com" viewBox="0 0 150 150" fill="currentColor">
      <defs>
      ...
      <g id="Layer_2" data-name="Layer 2">
        <path id="Layer_3" data-name="Layer 3" class="fill-none" d="M0,0H150V150H0V0Z"/>
      </g>
      <path class="fill-current" d="M57.53,128.19c-5.86-5.34-7.57-16.57-5.13-24.7,4.23,5.13,10.1,6.75,16.17,7.67,10.41,1.56,21.21,.76,30.3-5.19,2.64,7.89-1.02,16.49-7.6,21.14-8.36,5.63-14.92,8.86-10.92,20.26-6.02-2.64-9.6-8.59-9.64-15-.02-1.6-.02-3.21-.24-4.79-.53-3.84-2.33-5.56-5.74-5.66-3.89-.16-6.6,2.57-7.21,6.27h0Z"/>
...
`,
  ionic: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://ionicframework.com/">
    <i class="devicon-ionic-original text-2xl sm:text-3xl"></i>
  </a>
`,
  capacitor: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://capacitorjs.com/">
    <svg viewBox="0 0 512 512" fill="none" class="w-6 sm:w-7" xmlns="http://www.w3.org/2000/svg">
      <path fill="currentColor" d="M480 101.09L372.37 208.72l106.86 107.06l-69.3 69.3l-283.22-283.23L196 32.54l107.07 106.88L410.67 32ZM32.55 196l69.3-69.31l283.22 283.24l-69.3 69.3l-107-106.87L101.08 480L32 410.67l107.42-107.61Z"/>
    </svg>
  </a>
`,
  // fill="currentColor
  vercel: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://vercel.com/">
...
`,
  cloudflare: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://www.cloudflare.com/">
  <svg xmlns="http://www.w3.org/2000/svg" class="w-7 sm:w-8" id="Layer_1" data-name="Layer 1" viewBox="0 0 209.51 94.74"><path class="fill-current" d="M143.05,93.42l1.07-3.71c1.27-4.41.8-8.48-1.34-11.48-2-2.76-5.26-4.38-9.25-4.57L58,72.7a1.47,1.47,0,0,1-1.35-2,2,2,0,0,1,1.75-1.34l76.26-1c9-.41,18.84-7.75,22.27-16.71l4.34-11.36a2.68,2.68,0,0,0,.18-1,3.31,3.31,0,0,0-.06-.54,49.67,49.67,0,0,0-95.49-5.14,22.35,22.35,0,0,0-35,23.42A31.73,31.73,0,0,0,.34,93.45a1.47,1.47,0,0,0,1.45,1.27l139.49,0h0A1.83,1.83,0,0,0,143.05,93.42Z"/><path class="fill-current" d="M168.22,41.15q-1,0-2.1.06a.88.88,0,0,0-.32.07,1.17,1.17,0,0,0-.76.8l-3,10.26c-1.28,4.41-.81,8.48,1.34,11.48a11.65,11.65,0,0,0,9.24,4.57l16.11,1a1.44,1.44,0,0,1,1.14.62,1.5,1.5,0,0,1,.17,1.37,2,2,0,0,1-1.75,1.34l-16.73,1c-9.09.42-18.88,7.75-22.31,16.7l-1.21,3.16a.9.9,0,0,0,.79,1.22h57.63A1.55,1.55,0,0,0,208,93.63a41.34,41.34,0,0,0-39.76-52.48Z"/></svg>
  </a>
`,
  figma: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://www.figma.com/">
    <i class="devicon-figma-plain text-[1.35rem] sm:text-[1.7rem]"></i>
  </a>
`,
  mySQL: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://www.mysql.com/">
    <i class="devicon-mysql-plain text-2xl sm:text-3xl"></i>
  </a>
`,
  php: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://www.php.net/manual/en/intro-whatis.php">
    <i class="devicon-php-plain text-3xl sm:text-4xl"></i>
  </a>
`,
  firebase: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://firebase.google.com/">
    <i class="devicon-firebase-plain text-[1.7rem] sm:text-[2rem]"></i>
  </a>
`,
  java: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://www.java.com/en/">
    <i class="devicon-java-plain text-2xl sm:text-3xl"></i>
  </a>
`,
  androidStudio: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://developer.android.com/">
    <i class="devicon-androidstudio-plain text-2xl sm:text-3xl"></i>
  </a>
`,
  xcode: `
  <a class="hover:scale-110 transition-transform duration-200" target="_blank" href="https://developer.apple.com/xcode/">
